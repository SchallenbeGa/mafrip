...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Prawa autorskie 2010 - :current_year, Roudoudou (zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'contact-us'             => 'Kontakt',
                'currency'               => 'Waluta',
                'footer-text'            => '© Prawa autorskie 2010 - 2023, Roudoudou (Zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
                'locale'                 => 'Lokalizacja',
