...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2010 - :current_year, mafrip (Registrado na Índia). Todos os direitos reservados.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Moeda',
                'footer-text'            => '© Direitos Autorais 2010 - 2023, mafrip (Registrada na Índia). Todos os direitos reservados.',
                'locale'                 => 'Localização',
