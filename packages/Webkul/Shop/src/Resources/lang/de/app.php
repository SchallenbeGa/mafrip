...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2010 - :current_year, mafrip (in Indien registriert). Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Währung',
                'footer-text'            => '© Copyright 2010 - 2023, mafrip (registriert in Indien). Alle Rechte vorbehalten.',
                'locale'                 => 'Sprache',
