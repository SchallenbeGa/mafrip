...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Auteursrecht 2010 - :current_year, mafrip (geregistreerd in India). Alle rechten voorbehouden.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Valuta',
                'footer-text'            => '© Auteursrecht 2010 - 2023, mafrip (geregistreerd in India). Alle rechten voorbehouden.',
                'locale'                 => 'Taal',
