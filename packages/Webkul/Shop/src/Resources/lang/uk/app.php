...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Копірайт 2010 - :current_year, mafrip (зареєстрована в Індії). Всі права захищені.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Валюта',
                'footer-text'            => '© Авторські права 2010 - 2023, mafrip (зареєстровано в Індії). Усі права захищені.',
                'locale'                 => 'Мова',
