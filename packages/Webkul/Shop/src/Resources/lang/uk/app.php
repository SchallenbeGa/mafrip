...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Копірайт 2010 - :current_year, Roudoudou (зареєстрована в Індії). Всі права захищені.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Валюта',
                'footer-text'            => '© Авторські права 2010 - 2023, Roudoudou (зареєстровано в Індії). Усі права захищені.',
                'locale'                 => 'Мова',
