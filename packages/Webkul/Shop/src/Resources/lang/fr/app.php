...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Droits d’auteur 2010 - :current_year, mafrip (enregistré en Inde). Tous droits réservés.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Devise',
                'footer-text'            => '© Droits d\'auteur 2010 - 2023, mafrip (enregistré en Inde). Tous droits réservés.',
                'locale'                 => 'Langue',
