...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Derechos de autor 2010 - :current_year, mafrip (Registrado en India). Todos los derechos reservados.',
        ...
        'reset-password' => [
            ...
            'footer'           => '© Derechos de autor 2010 - :current_year, mafrip (Registrada en India). Todos los derechos reservados.',
            'password'         => 'Contraseña',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'contact-us'             => 'Kontakt',
                'currency'               => 'Währung',
                'footer-text'            => '© Urheberrecht 2010 - 2023, mafrip (registriert in Indien). Alle Rechte vorbehalten.',
                'locale'                 => 'Sprache',
