...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Авторское право 2010 - :current_year, mafrip (зарегистрировано в Индии). Все права защищены.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Валюта',
                'footer-text'            => '© Авторские права 2010 - 2023, mafrip (зарегистрирована в Индии). Все права защищены.',
                'locale'                 => 'Язык',
