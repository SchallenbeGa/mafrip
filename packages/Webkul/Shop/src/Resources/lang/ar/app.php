...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© حقوق الطبع والنشر 2010 - :current_year، Roudoudou (مسجلة في الهند). جميع الحقوق محفوظة.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'contact-us'             => 'اتصل بنا',
                'currency'               => 'العملة',
                'footer-text'            => '© حقوق النشر 2010 - 2023 ، Roudoudou (مسجلة في الهند). كل الحقوق محفوظة.',
                'locale'                 => 'اللغة',
